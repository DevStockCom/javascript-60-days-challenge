...
// 1. Filter the list of inventors for those who were born in the between 1500 and 1700
const oldmans = inventors.filter(function(inv) {
    if(inv.year >= 1500 && inv.year < 1700) {
        return true;
    }
});

console.table(oldmans);
...
const yearsLive = inventors.reduce((total, inv) => {
